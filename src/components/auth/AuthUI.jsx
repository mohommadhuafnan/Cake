...
function GoogleSignInButton({ onClick, loading, label }) {
  return (
    <motion.button
      ...
      onClick={onClick}
      disabled={loading}
      className="auth-btn-google w-full py-3.5 rounded-xl text-sm font-medium flex items-center justify-center gap-3 disabled:opacity-60"
              ...
              {!isSignup && showForgot && (
                ...
                >
                  <motion.div variants={itemVariants}>
                    ...
                    <p className="text-muted text-sm">{t('auth.resetPasswordSubtitle')}</p>
                  </motion.div>
                  ...
                  {success && (
                    <motion.p variants={itemVariants} className="text-green-600 text-sm">
                      {success}
                    </motion.p>
                  )}
                  ...
                  <motion.p variants={itemVariants} className="auth-mode-toggle text-center text-sm">
                    <button type="button" onClick={() => setShowForgot(false)} className="text-gold hover:underline">
                      {t('auth.backToLogin')}
                    </button>
                  </motion.p>
                </motion.form>
                ...
                >
                  ...
                  {onGoogleSignIn && (
                    <motion.div variants={itemVariants} className="space-y-4">
                      ...
                      />
                      <OrEmailDivider label={t('auth.orEmail')} />
                    </motion.div>
                  )}
                  ...
                  {onResetPassword && (
                    <motion.div variants={itemVariants} className="-mt-2 text-end">
                      <button
                        type="button"
